...
def plot_net_benefit(all_models):
    ...
    all_models : dict
        ...
        Model dict'leri şu yapıya sahip olmalı:
        - 'all_model_test_outputs' adlı dict içinde:
          - 'test_real_labels' : Gerçek test etiketleri (0/1) (list veya numpy array)
          - 'test_probs' : Modelin test için tahmin olasılıkları (list veya numpy array)
    """

    thresholds = np.linspace(0.01, 0.99, 99)  # Eşikler, 0 ve 1 dışında
    ...
    for model_name, model_dict in all_models.items():
        ...
        for thresh in thresholds:
            # Eşikten yüksek olanlar pozitif kabul edilir
        ...
        # "Tüm hastaları pozitif kabul et" stratejisi (all positive)
        ...
        # "Hiçbir model kullanma" stratejisi
